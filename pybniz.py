...
Les sets sont enregistrés dans le sous-répertoire 'sets/' en format texte, le nom du fichier est utilisé pour nommer le set. La première ligne '\ xyt:' est utilisé pour mémoriser la position et la taille de la fenêtre.

Pré-requis:
la librairie SDL1.2 et le module Python Tkinter
- Debian : sudo apt-get install libsdl1.2* python-tk
...
de manipulations des sets, et lance IBNIZ avec les bonnes options"""
    ...
    def sauveSet(self, nomset, texte, posx, posy, taille):
        ...
        texte = ''.join(c for c in normalize('NFD', texte) if category(c) != 'Mn') 
...
class PybnizUI(Frame):
    ...
    def creerInterface(self):
        ...
        # La zone d'affichage
        self.zoneAffichage=Text(self,font="Courier 14 bold",height=21,width=52)
        self.zoneAffichage.pack(pady=5, padx=10, fill='x')
